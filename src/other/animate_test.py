##
## Test script @ January 7th, 2021: try the animate thing a bit ..
##
...
def main():
    """
        main def()
    """
    time_steps = [i for i in range(0,500,10)]  #[10, 20, 30, 40, 50]
    maximum_values = []
    i = 1
    ...
    ani = animation.FuncAnimation(figure, ploter.animate, interval=1000)
    plt.show()
